...
$(document).ready(function() {
	...
	Dase.initMocks();
	Dase.initDataSetCreateForm();
});

Dase.initDataSetCreateForm = function() {
	$('#data_set_create').submit(function() {
...
Dase.initMocks = function() {
	$("ul#mocks a").click(function() {
